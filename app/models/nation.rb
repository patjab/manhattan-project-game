class Nation < ApplicationRecord
  ...
  has_many :challengers, class_name: 'Nation', through: :challenger_matches, foreign_key: 'challenger_id'

  has_many :challenged_matches, class_name: 'Match', foreign_key: 'challenger_id'
  has_many :challengeds, class_name: 'Nation', through: :challenged_matches, foreign_key: 'challenged_id'
