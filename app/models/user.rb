class User < ApplicationRecord
  ...
  #has_many :matches
  # has_many :challengers, class_name: 'User', through: :matches, foreign_key: 'challenger_id'
  # has_many :challengeds, class_name: 'User', through: :matches, foreign_key: 'challenged_id'
