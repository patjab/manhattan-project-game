class UsersController < ApplicationController
  ...
  def update
    ...
    if params[:user][:user_name] || params[:user][:nation_name]
      @user.update(user_name: params[:user][:user_name], nation_name: params[:user][:nation_name].capitalize)
      redirect_to matches_path(id: @user.id, message: "Your name was successfully changed.")
      ...
      @message = "You must submit a change."
      render :'edit.html'
    end
  end
