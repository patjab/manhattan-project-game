...
# Question.create(question: "Which equation best represents a circle on an x-y coordinate system, where r is the radius?", option_a: "none of any of these", option_b: "(x + y)^2 = r^2", option_c: "y^2, stage: "x^2 = r^2", option_d: "x^2, stage: "y^2 = r^2", answer: "x^2 + y^2 = r^2"),
...
# Question.create(question: "Which of the following statements about natural logarithms is false?", option_a: "ln(a*b) = ln(a) + ln(b)", option_b: "ln(e) = 1", option_c: "ln(a^b) = b * ln(a)", option_d: "all of these are true", answer: "ln(b/a) = ln(a), stage: "ln(b)"),
...
Stage.destroy_all
Stage.create(year: 1919, stage: "RESEARCH", message: "You have discovered the proton by changing the form of nitrogen into oxygen")
Stage.create(year: 1929, stage: "RESEARCH", message: "You have built the cyclotron")
Stage.create(year: 1931, stage: "RESEARCH", message: "You have discovered the neutron")
Stage.create(year: 1932, stage: "RESEARCH", message: "You have split an atom thereby proving the theory of relativity")
Stage.create(year: 1933, stage: "INVESTIGATING", message: "Eureka! You realize it's possible to make a bomb by releasing energy through a chain reaction of neutrons colliding into nuclei")
Stage.create(year: 1939, stage: "INVESTIGATING", message: "At a conference, you present the world a Theory of Nuclear Fission")
Stage.create(year: 1939, stage: "INVESTIGATING", message: "Concerned about the discovery of fission you have written a leader to your country's prime minister.")
Stage.create(year: 1941, stage: "INVESTIGATING", message: "You discover plutonium")
Stage.create(year: 1941, stage: "BUILDING", message: "Your prime minister asks you to begin construction on the bomb")
Stage.create(year: 1942, stage: "BUILDING", message: "You begin building reactors to produce plutonium and electromagnetic, centrifuge and gaseous diffusion plants to produce uranium-235")
Stage.create(year: 1942, stage: "BUILDING", message: "You choose a site to build a bomb laboratory.")
Stage.create(year: 1942, stage: "BUILDING", message: "You have successfully created the first controlled chain reaction of uranium fission.")
Stage.create(year: 1943, stage: "TESTING", message: "Bomb design begins")
Stage.create(year: 1945, stage: "TESTING", message: "Plutonium reaches your bomb site")
Stage.create(year: 1945, stage: "TESTING", message: "Demonstrate implosion compression in full scale test")
Stage.create(year: 1945, stage: "TESTING", message: "Begin assembly of The Trinity Test Gadget")
